  ...
  methods: {
    ...
    getEnclosureList () {//获取围栏列表
      ...
      if(response.data.Code==200){
          console.log(response.data.ResultsData[0])
          // var lnglat=response.data.ResultsData
          // console.log('lnglat:'+response.data.ResultsData)
          // console.log('lnglat:'+lnglat)
          // for (var i = 0; i < lnglat.length; i++) {
          // console.log('lnglat:'+lnglat[i])
          //   this.path[i] = lnglat[i];
          // }

          // this.path=response.data.ResultsData
          ...
          this.polygon = new AMap.Polygon({
            ...
            // console.log(e.target.w.path[0].lat)

<template>
  <div>
    <!-- <List :forms="forms" :tables="tables"></List> -->
...
export default {
  ...
  methods: {
    getList () {
      // console.log(this.$children[0].pager)
      let json={
        // pageNum: this.$children[0].pager.pageNum,
        // pageSize: this.$children[0].pager.pageSize,
        pageNum: 1,
        pageSize: 10,
        UserName: '',
        ProjectName: ''
      }
      var url = '/api/Admin_Project/ProjectAuditList';
